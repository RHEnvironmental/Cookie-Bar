(function () {
	...
	*/
	...
	var queueMicrotaskDescriptor = getOwnPropertyDescriptor$5(global$1, 'queueMicrotask');
	...
	var FORCED$j = !global$1.setImmediate || !global$1.clearImmediate;
	...
	var css_248z$1 = ".styles_closeLine__3g1DS {\n  position: relative;\n  float: right;\n  padding: 6px;\n  border: none;\n  width: 40px;\n  height: 40px; }\n  .styles_closeLine__3g1DS:hover {\n    cursor: pointer; }\n  .styles_closeLine__3g1DS div {\n    position: absolute;\n    width: 30px;\n    border-bottom: 2px solid #fff;\n    top: 50%;\n    left: 50%; }\n    .styles_closeLine__3g1DS div:first-of-type {\n      transform: translate(-50%) rotate(45deg); }\n    .styles_closeLine__3g1DS div:last-of-type {\n      transform: translate(-50%) rotate(-45deg); }\n";
	var css$1 = {"closeLine":"styles_closeLine__3g1DS"};
	styleInject(css_248z$1);

	var CloseButton = function CloseButton(props) {
	  return h("button", {
	    className: css$1.closeLine,
	...
	var css_248z$2 = ".styles_dropdown_container__2DJtm {\n  margin-top: 12px;\n  margin-right: -12px;\n  margin-bottom: 0;\n  margin-left: -12px; }\n  .styles_dropdown_container__2DJtm > div {\n    border-top: 1px solid #D2D2D2; }\n    .styles_dropdown_container__2DJtm > div:last-child {\n      border-bottom: 1px solid #D2D2D2; }\n";
	var css$2 = {"dropdown_container":"styles_dropdown_container__2DJtm"};
	styleInject(css_248z$2);

	var DropdownContainer = function DropdownContainer(props) {
	  return h("div", {
	    className: css$2.dropdown_container
	  }, props.children);
	};

	var css_248z$3 = ".styles_switch__2w1yM {\n  position: relative;\n  display: inline-block;\n  width: 70px;\n  height: 30px; }\n\n.styles_switch__2w1yM input {\n  opacity: 0;\n  width: 0;\n  height: 0; }\n\n.styles_slider__oGmX5 {\n  position: absolute;\n  cursor: pointer;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: #ccc;\n  -webkit-transition: .4s;\n  transition: .4s;\n  border-radius: 34px; }\n\n.styles_slider__oGmX5:before {\n  position: absolute;\n  content: \"\";\n  height: 22px;\n  width: 22px;\n  left: 4px;\n  bottom: 4px;\n  background-color: white;\n  -webkit-transition: .4s;\n  transition: .4s;\n  border-radius: 50%;\n  box-shadow: 0 4px 4px rgba(0, 0, 0, 0.25); }\n\ninput:checked + .styles_slider__oGmX5:before {\n  -webkit-transform: translateX(40px);\n  -ms-transform: translateX(40px);\n  transform: translateX(40px); }\n";
	var css$3 = {"switch":"styles_switch__2w1yM","slider":"styles_slider__oGmX5"};
	styleInject(css_248z$3);

	var Toggle = function Toggle(props) {
	  return h("div", {
	    className: props.className && props.className
	  }, h("style", null, "                    input:checked + .".concat(css$3.slider, " {                        background-color: ").concat(props.primaryColor, ";                    }                                        input:focus + .").concat(css$3.slider, " {                        box-shadow: 0 0 1px ").concat(props.primaryColor, ";                    }                ")), h("label", {
	    className: css$3.switch
	  }, h("input", {
	    type: "checkbox",
	    checked: props.checked,
	    onChange: props.handleChange
	  }), h("span", {
	    className: css$3.slider
	  })));
	};

	var cookieChange = new CustomEvent("consentCookieChange", {
	  detail: js_cookie.get('cookie_consent'),
	  bubbles: true,
	  composed: true
	});

	var css_248z$4 = ".styles_dropdown_item_title_container__13nXR {\n  display: flex;\n  padding: 4px 12px; }\n\n.styles_arrow_container__g016z {\n  position: relative;\n  width: 38px;\n  cursor: pointer; }\n  .styles_arrow_container__g016z .styles_arrow__1FI81 {\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    margin-left: -6px;\n    width: 0;\n    height: 0; }\n    .styles_arrow_container__g016z .styles_arrow__1FI81.styles_down__2sXz- {\n      border-left: 6px solid transparent;\n      border-right: 6px solid transparent;\n      border-top: 6px solid #000; }\n    .styles_arrow_container__g016z .styles_arrow__1FI81.styles_up__1rEiD {\n      border-left: 6px solid transparent;\n      border-right: 6px solid transparent;\n      border-bottom: 6px solid #000; }\n\n.styles_dropdown_item_title__3tpT0 {\n  flex: 5;\n  cursor: pointer; }\n  .styles_dropdown_item_title__3tpT0 h3 {\n    margin: 12px 0 !important;\n    line-height: 1 !important;\n    border-bottom: none;\n    font-size: 15px !important;\n    font-weight: bold !important; }\n\n.styles_category_toggle__1kBOa {\n  position: relative;\n  flex: 1;\n  padding-top: 4px; }\n  .styles_category_toggle__1kBOa p.styles_always_active__1wPZ- {\n    font-weight: bold;\n    text-align: right;\n    margin: 7px 0 0 0; }\n  .styles_category_toggle__1kBOa .styles_toggle__340pj {\n    float: right; }\n\n.styles_dropdown_item_content__2D0pC {\n  background-color: #F5F6F8;\n  margin-top: 0;\n  margin-right: -12px;\n  margin-bottom: 0;\n  margin-left: -12px;\n  padding: 10px 50px; }\n  .styles_dropdown_item_content__2D0pC p {\n    margin-top: 0; }\n\ntable.styles_cookie_table__LjiLI {\n  width: 100%;\n  border-collapse: collapse;\n  caption-side: bottom;\n  background: none;\n  border: none; }\n  table.styles_cookie_table__LjiLI th, table.styles_cookie_table__LjiLI td {\n    font-size: 15px;\n    font-weight: normal;\n    vertical-align: top;\n    text-align: left;\n    padding: 5px 10px 5px 0;\n    border-top: none !important;\n    border-right: none !important;\n    border-bottom: 1px solid #D2D2D2;\n    border-left: none !important; }\n    table.styles_cookie_table__LjiLI th:first-child, table.styles_cookie_table__LjiLI td:first-child {\n      width: 20%; }\n    table.styles_cookie_table__LjiLI th:last-child, table.styles_cookie_table__LjiLI td:last-child {\n      width: 80%; }\n  table.styles_cookie_table__LjiLI tr:last-child td {\n    border-bottom: none; }\n";
	var css$4 = {"dropdown_item_title_container":"styles_dropdown_item_title_container__13nXR","arrow_container":"styles_arrow_container__g016z","arrow":"styles_arrow__1FI81","down":"styles_down__2sXz-","up":"styles_up__1rEiD","dropdown_item_title":"styles_dropdown_item_title__3tpT0","category_toggle":"styles_category_toggle__1kBOa","always_active":"styles_always_active__1wPZ-","toggle":"styles_toggle__340pj","dropdown_item_content":"styles_dropdown_item_content__2D0pC","cookie_table":"styles_cookie_table__LjiLI"};
	...
	var DropdownItem = /*#__PURE__*/function (_Component) {
	  ...
	  _createClass(DropdownItem, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var cookieConsent = JSON.parse(js_cookie.get('cookie_consent'));
	    ...
	    value: function _handleChange(e, categoryId) {
	      ...
	      js_cookie.set('cookie_consent', JSON.stringify(this.state.cookieConsent));
	    ...
	    value: function render() {
	      ...
	      return h("div", {
	        className: css$4.dropdown_item
	      }, h("div", {
	        className: css$4.dropdown_item_title_container
	      }, h("div", {
	        className: css$4.arrow_container,
	        onClick: this._toggleShowItemContent.bind(this)
	      }, h("div", {
	        className: this.state.showItemContent ? "".concat(css$4.arrow, " ").concat(css$4.up) : "".concat(css$4.arrow, " ").concat(css$4.down)
	      })), h("div", {
	        className: css$4.dropdown_item_title,
	        onClick: this._toggleShowItemContent.bind(this)
	      }, h("h3", null, this.props.category)), h("div", {
	        className: css$4.category_toggle
	      }, this.props.categoryID === 'ESSENTIAL' ? h("p", {
	        className: css$4.always_active,
	        style: {
	          color: this.props.primaryColor
	        }
	      }, "Always Active") : h(Toggle, {
	        className: css$4.toggle,
	        checked: this.state.categoryAccepted,
	        primaryColor: this.props.primaryColor,
	        handleChange: function handleChange(e) {
	          return _this3._handleChange(e, _this3.props.categoryID);
	        }
	      }))), this.state.showItemContent && h("div", {
	        className: css$4.dropdown_item_content
	      }, h("p", null, this.props.categoryDescription), h("table", {
	        className: css$4.cookie_table
	      }, h("tr", null, h("th", null, "Cookie"), h("th", null, "Description")), this.props.categoryCookies.map(function (cookie) {
	        return h("tr", null, h("td", null, cookie.name), h("td", null, cookie.description));
	      }))));
	    }
	  }]);
	...
	var css_248z$5 = ".styles_modal_background__11oex {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  overflow-y: auto;\n  background-color: rgba(0, 0, 0, 0.25);\n  z-index: 1000; }\n\n.styles_modal_container__1QywV {\n  position: fixed;\n  top: 50%;\n  left: 50%;\n  width: 90%;\n  transform: translate(-50%, -50%);\n  background-color: #fff;\n  box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);\n  border-radius: 10px;\n  overflow: auto; }\n  .styles_modal_container__1QywV h2 {\n    border-bottom: none; }\n    .styles_modal_container__1QywV h2.styles_modal_main_header__1FMUo {\n      margin: 0 0 12px 0; }\n  .styles_modal_container__1QywV p {\n    padding: 0; }\n  @media (min-width: 768px) {\n    .styles_modal_container__1QywV {\n      width: 800px; } }\n\n.styles_modal_scroll__Jy0fR {\n  max-height: 680px;\n  overflow: auto; }\n\n.styles_modal_section__1pUyv {\n  padding: 12px;\n  border-bottom: 1px solid #D2D2D2;\n  overflow: hidden; }\n  .styles_modal_section__1pUyv.styles_no_border__2tldV {\n    border-bottom: none; }\n  .styles_modal_section__1pUyv h2 {\n    margin: 0;\n    font-size: 20px;\n    font-weight: bold; }\n  .styles_modal_section__1pUyv p {\n    font-size: 15px; }\n  .styles_modal_section__1pUyv:last-child {\n    border-bottom: none; }\n\n.styles_footer_buttons_container__390E3 button:first-of-type {\n  margin-right: 12px; }\n\n.styles_footer_buttons_container__390E3 button:last-of-type {\n  float: right; }\n";
	var css$5 = {"modal_background":"styles_modal_background__11oex","modal_container":"styles_modal_container__1QywV","modal_main_header":"styles_modal_main_header__1FMUo","modal_scroll":"styles_modal_scroll__Jy0fR","modal_section":"styles_modal_section__1pUyv","no_border":"styles_no_border__2tldV","footer_buttons_container":"styles_footer_buttons_container__390E3"};
	...
	var Modal = function Modal(props) {
	  function rejectAllCookies() {
	    ...
	    js_cookie.set('cookie_consent', JSON.stringify(cookieConsent));
	  ...
	  return h("div", {
	    className: css$5.modal_background
	  }, h("div", {
	    className: css$5.modal_container
	  }, h("div", {
	    className: css$5.modal_section
	  }, h(CloseButton, {
	    toggleShowModal: props.toggleShowModal,
	    primaryColor: props.primaryColor
	  })), h("div", {
	    className: css$5.modal_scroll
	  }, h("div", {
	    className: "".concat(css$5.modal_section, " ").concat(css$5.no_border)
	  }, h("h2", {
	    className: css$5.modal_main_header,
	    style: {
	      color: props.primaryColor
	    }
	  }, "Our use of cookies"), h("p", null, window.cookieBarSettings.introText, " ", window.cookieBarSettings.hasMoreInfo && h("a", {
	  ...
	  }, "Manage Consent Preferences"), h(DropdownContainer, null, window.cookieBarSettings.cookies.map(function (cookie) {
	    ...
	    className: css$5.footer_buttons_container
	  }, h(Button, {
	    cancel: true,
	...
	var Feature = function Feature(props) {
	  ...
	  if (props.fallback) {
	    return h("div", null, props.fallback);
	  }

	  return null;
	};

	var css_248z$6 = ".styles_cookiebar_container__2UWdI {\n  position: fixed;\n  bottom: 0;\n  right: 0;\n  left: 0;\n  padding: 12px;\n  background: #fff;\n  font-family: inherit;\n  z-index: 100; }\n  .styles_cookiebar_container__2UWdI h2, .styles_cookiebar_container__2UWdI p {\n    margin: 0 0 16px;\n    padding: 0; }\n\n.styles_header_button_container__14Qds {\n  padding-top: 10px;\n  float: left; }\n  .styles_header_button_container__14Qds button {\n    margin-right: 12px; }\n  @media (min-width: 768px) {\n    .styles_header_button_container__14Qds {\n      float: right; }\n      .styles_header_button_container__14Qds button {\n        margin-right: 0; } }\n";
	var css$6 = {"cookiebar_container":"styles_cookiebar_container__2UWdI","header_button_container":"styles_header_button_container__14Qds"};
	styleInject(css_248z$6);

	var css_248z$7 = ".global_container__1kY2f {\n  display: block;\n  width: 100%;\n  margin: 0 auto; }\n  .global_container__1kY2f * {\n    box-sizing: border-box; }\n  @media (min-width: 768px) {\n    .global_container__1kY2f {\n      width: 768px; } }\n  @media (min-width: 992px) {\n    .global_container__1kY2f {\n      width: 992px; } }\n  @media (min-width: 1200px) {\n    .global_container__1kY2f {\n      width: 1200px; } }\n\n.global_col_8__27bRn, .global_col_4__H5Qs3 {\n  display: block;\n  float: left;\n  padding: 0 12px; }\n\n.global_col_8__27bRn {\n  width: 100%; }\n  @media (min-width: 768px) {\n    .global_col_8__27bRn {\n      width: 70%; } }\n\n.global_col_4__H5Qs3 {\n  width: 100%; }\n  @media (min-width: 768px) {\n    .global_col_4__H5Qs3 {\n      width: 30%; } }\n\n.global_title__3NePV {\n  font: inherit; }\n\n@media (max-width: 767px) {\n  .global_hidden_xs__3nHY7 {\n    display: none; } }\n";
	var globalStyles = {"container":"global_container__1kY2f","col_8":"global_col_8__27bRn","col_4":"global_col_4__H5Qs3","title":"global_title__3NePV","hidden_xs":"global_hidden_xs__3nHY7"};
	...
	var CookieBar = /*#__PURE__*/function (_Component) {
	  ...
	  _createClass(CookieBar, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      if (js_cookie.get('cookie_consent')) {
	        var cookieConsent = JSON.parse(js_cookie.get('cookie_consent'));
	    ...
	    value: function render() {
	      ...
	      return h(Feature, {
	        ...
	        id: "cookiebar",
	        className: css$6.cookiebar_container
	      }, h("div", {
	      ...
	      }, h("strong", null, "Use of our cookies")), h("p", null, window.cookieBarSettings.introText, " ", window.cookieBarSettings.hasMoreInfo && h("a", {
	        href: window.cookieBarSettings.moreInfoUrl
	      }, "More Info"))), h("div", {
	        className: globalStyles.col_4
	      }, h("div", {
	        className: css$6.header_button_container
	      }, h(Button, {
	        primaryColor: this.props.primaryColor,
	        onClick: this._acceptAllCookies.bind(this)
	      }, "Accept All"), h("br", {
	        className: globalStyles.hidden_xs
	      }), h(Button, {
	        primaryColor: this.props.primaryColor,
	        inverted: true,
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      if (!js_cookie.get('cookie_consent')) {
	        ...
	        js_cookie.set('cookie_consent', JSON.stringify(cookies));
	      }
	    }
	  }, {
	    key: "render",
